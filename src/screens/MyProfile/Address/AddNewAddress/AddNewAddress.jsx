...
const AddNewAddress = ({ route, navigation }) => {
    ...
    const handleAddNewAddress = async () => {
        handleValidation();
        addAddressApi(setIsLoading, addressInfo, ipAddress).then((status) => {
            if (status) {
                showAddressApi(setIsLoading, ipAddress).then((result) => {
                    if (result) {
    ...
    const handleUpdateAddress = () => {
        handleValidation();
        updateAddressApi(setIsLoading, addressInfo, ipAddress).then((status) => {
            if (status) {
