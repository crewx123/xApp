...
export const loginApi = async (setLoader, loginCredentials, setErrors, setUserInformation, ipAddress) => {
  setLoader(true);
  try {
    const sendRequest = await axios.post(`http://${ipAddress}/users/login`, loginCredentials,
      {
        headers: {
