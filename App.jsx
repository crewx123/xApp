...
import PrivcyPolicy from './src/screens/MyProfile/policy/Policy';
...
const App = () => {
  ...
  return (
    ...
    <AuthProvider>
      ...
      {/* <AppNavigator /> */}
      <Stack.Navigator
        initialRouteName='Login Welcome'
        screenOptions={{
      ...
      >
        ...
        <Stack.Screen name='policy' component={PrivcyPolicy} options={{
